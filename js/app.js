...
MetronicApp.controller('AppController', ['$http', '$scope', '$rootScope', function($http, $scope, $rootScope) {
    ...
    $http.get('/api/slidebar').then(function(response){
        $scope.app.slidebar = response.data;
    });
}]);
